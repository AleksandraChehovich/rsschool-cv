...
const max = 1;
const min = 7;
const colorArray = ['green', 'orange', 'grey', 'violet', 'yellow', 'blue', 'red'];
...
sendButton.onclick = function() {
    socket.emit('send_message', {mess: currentMessage.value, usName: userName.value || 'Anonimous', color: randomColor});
